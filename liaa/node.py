...
from typing import Optional, List, Tuple, Set, Iterator, Any
import heapq
import logging
...
class NetworkNode(Node):
    def __init__(self, key: str):
		...
		"""
        super(NetworkNode, self).__init__(key)
...
class StorageNode(Node):
    def __init__(self, key: str, value: bytes, birthday=Optional[float]):
        """
		Referenced as the {key, value} pair in the protocol
		"""
        super(StorageNode, self).__init__(key)
